...
export const CREATE_INCOME_MUTATION = gql`
  mutation createIncomeMutation($user_id: uuid!, $income_from: String!, $amount: numeric!, $date_earned: String!) {
...
export const CREATE_EXPENSES_MUTATION = gql`
  mutation createExpenses($user_id: uuid!, $date: String!, $name: String!, $cost: numeric!, $prev_balance: numeric!) {
...
export const ADD_TOTAL_INCOME_MUTATION = gql`
  mutation addTotalIncomeMutation($user_id: uuid!, $sum: numeric!) {
...
export const UPDATE_TOTAL_INCOME_MUTATION = gql`
  mutation updateTotalIncomeById($user_id: uuid!, $income: numeric!) {
